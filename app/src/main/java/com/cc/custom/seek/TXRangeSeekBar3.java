 ...
 */
public class TXRangeSeekBar3 extends View {

    private static final String TAG = "TXRangeSeekBar3";
    ...
    private TXOnScrollListener mScrollListener;

    public void setScrollListener(TXOnScrollListener listener) {
        this.mScrollListener = listener;
    }

    public interface TXOnScrollListener {
        void onScroll(int distanceX);
    }

    public TXRangeSeekBar3(Context context) {
        this(context, null);
    }

    public TXRangeSeekBar3(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TXRangeSeekBar3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private TXSliderListener mSliderListener;

    public void registerSliderListener(TXSliderListener listener) {
        this.mSliderListener = listener;
    }

    public interface  TXSliderListener {
        void onSliderUpdated(int sliderLeft, int sliderRight);
    }
    ...
    private boolean handleMove(MotionEvent event) {
        ...
        if (mIsLeftDown && mLeftPointerId != -1) {
            ...
            if (index != -1) {
                ...
                move = true;
                mSliderListener.onSliderUpdated(mSliderLeft, mSliderRight);
                invalidate();
            }
        }
