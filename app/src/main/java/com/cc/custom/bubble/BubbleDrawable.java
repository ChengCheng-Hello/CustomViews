...
public class BubbleDrawable extends Drawable {
    ...
    private void setUpLeftPath(RectF rect, Path path) {
        ...
        path.arcTo(
            new RectF(rect.left + mArrowWidth, rect.bottom - mAngle, mAngle + rect.left + mArrowWidth, rect.bottom), 90,
            90);
        ...
        path.arcTo(new RectF(rect.left + mArrowWidth, rect.top, mAngle + rect.left + mArrowWidth, mAngle + rect.top),
            180, 90);
        path.close();
    }
    ...
    private void setUpTopPath(RectF rect, Path path) {
        ...
        path.arcTo(
            new RectF(rect.right - mAngle, rect.top + mArrowHeight, rect.right, mAngle + rect.top + mArrowHeight), 270,
            90);
        path.lineTo(rect.right, rect.bottom - mAngle);
    ...
    private void setUpRightPath(RectF rect, Path path) {
        ...
        path.arcTo(new RectF(rect.right - mAngle - mArrowWidth, rect.top, rect.right - mArrowWidth, mAngle + rect.top),
            270, 90);
        ...
        path.arcTo(
            new RectF(rect.right - mAngle - mArrowWidth, rect.bottom - mAngle, rect.right - mArrowWidth, rect.bottom),
            0, 90);
    ...
    private void setUpBottomPath(RectF rect, Path path) {
        ...
        path.arcTo(
            new RectF(rect.right - mAngle, rect.bottom - mAngle - mArrowHeight, rect.right, rect.bottom - mArrowHeight),
            0, 90);
        ...
        path.arcTo(
            new RectF(rect.left, rect.bottom - mAngle - mArrowHeight, mAngle + rect.left, rect.bottom - mArrowHeight),
            90, 90);
