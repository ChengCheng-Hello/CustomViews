 ...
 */
public class TXCalendarDayPickerFragment extends TXBaseFragment {

    public static TXCalendarDayPickerFragment newInstance() {

        Bundle args = new Bundle();

        TXCalendarDayPickerFragment fragment = new TXCalendarDayPickerFragment();
